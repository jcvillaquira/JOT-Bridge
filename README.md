# JOT-Bridge
This projects consists of a Julia implementation of JOT, and algorithm to decompose a signal into jump, trend and oscillation, to the identification of sudden changes in the input forces of a system with the measurements in the system response.
